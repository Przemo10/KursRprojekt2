...
Parametry dodatkowe:
- parametr móWiący czy lis zostawia jednego królika`fox_leaves_rabbit` (parametr mówiący czy lis zostawia jednego królika)
- parametr mówiący czy wilk zjada małego psa `wolf_eats_dog` 
...
-  tabela gry `game`
- czy lis zostawia królika`foxparam`
- czy wilk zjada małego psa `wolfparam`
- `die1`,`die2`
Przykłady:
